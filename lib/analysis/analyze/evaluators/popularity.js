 ...
 */
function calculateDownloadsCountScore(info) {
 ...
 * @return {number} The score
 */
function calculateDownloadsAccelerationScore(info) {
    const downloads = info.npm.downloads;
 ...
 * @return {number} The score
 */
function calculateStarsCountScore(info) {
    return normalizeValue((info.github ? info.github.starsCount : 0) + info.npm.starsCount, [
        { value: 0, norm: 0 },
        { value: 5, norm: 0.2 },
        { value: 10, norm: 0.5 },
        { value: 50, norm: 0.7 },
 ...
 * @return {number} The score
 */
function calculateForksCountScore(info) {
    return normalizeValue(info.github ? info.github.forksCount : 0, [
        { value: 0, norm: 0 },
        { value: 10, norm: 0.4 },
        { value: 100, norm: 0.7 },
        { value: 500, norm: 0.9 },
 ...
 * @return {number} The score
 */
function calculateContributorsCountScore(info) {
    return normalizeValue(info.github ? info.github.contributors.length : 0, [
        { value: 0, norm: 0 },
        { value: 5, norm: 0.5 },
        { value: 100, norm: 1 },
    ]);
 ...
 * @return {number} The score
 */
function calculateSubscribersCountScore(info) {
    return normalizeValue(info.github ? info.github.subscribersCount : 0, [
        { value: 0, norm: 0 },
        { value: 10, norm: 0.4 },
        { value: 100, norm: 0.7 },
        { value: 500, norm: 0.9 },
 ...
 * @return {number} The score
 */
function calculateDependentsCountScore(info) {
    return normalizeValue(info.npm.dependentsCount, [
        { value: 0, norm: 0 },
        { value: 10, norm: 0.4 },
        { value: 50, norm: 0.7 },
        { value: 500, norm: 0.9 },
...
function popularity(info) {
    const scores = {
        starsCount: calculateStarsCountScore(info),
        forksCount: calculateForksCountScore(info),
        subscribersCount: calculateSubscribersCountScore(info),
        contributorsCount: calculateContributorsCountScore(info),
        dependentsCount: calculateDependentsCountScore(info),
        downloadsCount: calculateDownloadsCountScore(info),
        downloadsAcceleration: calculateDownloadsAccelerationScore(info),
    };
