...
function checkDepsVulnerabilities(name, dir) {
    ...
    return promiseRetry((retry) => {
        ...
        .catch((err) => err.stderr.indexOf('53,48,52,32,71,97,116,101,119,97,121,32,84,105,109,101,45,111,117,116') !== -1, retry)
        // Retry on network errors
        .catch((err) => gotRetries.transientErrors.some((code) => err.stderr.indexOf(code) !== -1), retry);
    })
