...
function inspectFiles(data, dir) {
    return Promise.props({
        ...
        hasChangelog: detectRepoChangelog(dir).then((file) => !!file),
    });
}
...
function checkDepsVulnerabilities(name, dir) {
    ...
    // Ignore JOI validation error of some modules, e.g.: `allthejs`
 ...
 * @param {array}  badges      The badges detected by the detect-readme-badges module to speed up the process
 *
