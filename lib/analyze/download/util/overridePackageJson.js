 ...
 *
 * The published package.json has higher priority than the one downloaded from the source code since is more exact.
...
function overridePackageJson(packageJson, tmpDir, options) {
    options = Object.assign({
        onlyIfBroken: false,  // True to only override if the downloaded package.json is broken; the download package.json will get
